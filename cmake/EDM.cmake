...
function(EDM _package)
  ...
  include_directories(${CMAKE_CURRENT_BINARY_DIR}/${_hdr_dir})
  include_directories(${CMAKE_CURRENT_SOURCE_DIR}/${_hdr_dir})
  ...
  foreach(_f ${${_package}_depends_orig})
    ...
    elseif(TARGET ${PROJECT_NAME}::${_f}) # the namespace, for example offline::
      list(APPEND ${_package}_depends ${PROJECT_NAME}::${_f})

      # This is used by the RootDict
      get_target_property(hdrs ${PROJECT_NAME}::${_f} INTERFACE_INCLUDE_DIRECTORIES)
      foreach(d ${hdrs})
        include_directories(${d})
      endforeach()
    elseif(TARGET junosw::${_f}) # the namespace, for example junosw::
      list(APPEND ${_package}_depends junosw::${_f})

      # This is used by the RootDict
      get_target_property(hdrs junosw::${_f} INTERFACE_INCLUDE_DIRECTORIES)
      foreach(d ${hdrs})
        include_directories(${d})
      endforeach()
    else()
  ...
  foreach (_f ${_files} ${ARG_HDRS})
    ...
    elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/include/${_f}.h") # special case for EDMUtil
  ...
  foreach (_f ${_files})
    ...
    ROOT_GENERATE_DICTIONARY(${CMAKE_CURRENT_BINARY_DIR}/src/${_f}Dict
      ...
      OPTIONS "-noIncludePaths" "-inlineInputHeader"
      )
  endforeach()
